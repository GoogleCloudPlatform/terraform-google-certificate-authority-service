...
| ca\_pool\_config | Configuration for the Certificate Authority pool. | <pre>object({<br>    create_pool = optional(object({<br>      name            = string<br>      enterprise_tier = optional(bool, false)<br>    }))<br>    use_pool = optional(object({<br>      id = string<br>    }))<br>  })</pre> | n/a | yes |
